...
from sphinx_fuzzer.fuzzer import CircuitFuzzer, create_circuit_config
from sphinx_fuzzer.settings import SPHINX_AVAILABLE_COMMITS_OR_BRANCHES
from sphinx_fuzzer.zkvm_project import CircuitProjectGenerator
from sphinx_fuzzer.zkvm_repository.install import install_sphinx
...
class SphinxFuzzerClient(FuzzerClient):
    def run(self):
...
def app():
    cli = SphinxFuzzerClient("Sphinx", "Sphinx", SPHINX_AVAILABLE_COMMITS_OR_BRANCHES)
    cli.start()
