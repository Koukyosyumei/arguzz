...
from ziren_fuzzer.fuzzer import CircuitFuzzer, create_circuit_config
from ziren_fuzzer.settings import ZIREN_AVAILABLE_COMMITS_OR_BRANCHES
from ziren_fuzzer.zkvm_project import CircuitProjectGenerator
from ziren_fuzzer.zkvm_repository.install import install_ziren
...
class ZirenFuzzerClient(FuzzerClient):
    def run(self):
...
def app():
    cli = ZirenFuzzerClient("Ziren", "Ziren", ZIREN_AVAILABLE_COMMITS_OR_BRANCHES)
    cli.start()
