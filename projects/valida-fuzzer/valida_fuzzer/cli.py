...
from valida_fuzzer.fuzzer import CircuitFuzzer, create_circuit_config
from valida_fuzzer.settings import VALIDA_AVAILABLE_COMMITS_OR_BRANCHES
from valida_fuzzer.zkvm_project import CircuitProjectGenerator
from valida_fuzzer.zkvm_repository.install import install_valida
...
class ValidaFuzzerClient(FuzzerClient):
    def run(self):
...
def app():
    cli = ValidaFuzzerClient("Valida", "Valida", VALIDA_AVAILABLE_COMMITS_OR_BRANCHES)
    cli.start()
